...
<div class="container p-2">
	<h1 class="p-1">Burger Tracker</h1>
	<table class="table table-gradient text-info text-center">
		<thead>
			<tr>
				<th>Burger Name</th>
		...
		<tbody>
			<c:forEach items="${allBurgers}" var="one" >
				<tr>
					...
					<td>${one.rating}</td>
					<td><a class="btn btn-warning" href='/burger/edit/${one.id}'>Edit</a></td>
				</tr>
			</c:forEach>
			</tbody>
	</table>
	<h1 class="p-3">Add Burger</h1>
		<form:form class="col-6 border rounded-4 border-dark text-end p-5" action="/burger/processBurger" method="post" modelAttribute="burger">
	    <div class="p-3">
	    ...
	    <input class="col-4 btn btn-primary m-3" type="submit" value="Submit"/>
	</form:form> 
